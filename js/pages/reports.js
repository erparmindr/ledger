...
window.Ledger.pages.renderReportsPage = function(){
  ...
  return ''
    ...
    + '      <button data-rtab="expense" '+(f.tab==="expense"?"active":"")+'>Expenses</button>'
    + '      <button data-rtab="income" '+(f.tab==="income"?"active":"")+'>Income</button>'
    + '      <button data-rtab="transfer" '+(f.tab==="transfer"?"active":"")+'>Transfers</button>'
    + '      <button data-rtab="refund" '+(f.tab==="refund"?"active":"")+'>Refunds</button>'
    + '    </div>'
    + '  </div>'
