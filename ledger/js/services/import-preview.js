...
window.Ledger.promptLinkTransfers = function(importedAccountId, importedIds){
  ...
  var html = ''
    + '<div class="modal-head"><h3>Link related transfers?</h3><button class="icon-btn" id="closeModalBtn" aria-label="Close">&times;</button></div>'
    + '<div class="modal-body">'
...
window.Ledger.openLinkTransferModal = function(txId){
  ...
  var html = ''
    + '<div class="modal-head"><h3>Link destination</h3><button class="icon-btn" id="closeModalBtn" aria-label="Close">&times;</button></div>'
    + '<div class="modal-body">'
