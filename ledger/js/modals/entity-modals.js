...
window.Ledger.openTxModal = function(existing){
  ...
  var html = ''
    + '<div class="modal-head"><h3>' + (isEdit?'Edit transaction':'New transaction') + '</h3><button class="icon-btn" id="closeModalBtn" aria-label="Close"><i data-lucide="x" style="width:18px;height:18px;"></i></button></div>'
...
window.Ledger.openAccountModal = function(existing){
  ...
  var html = ''
    + '<div class="modal-head"><h3>' + (isEdit?'Edit account':'Add account') + '</h3><button class="icon-btn" id="closeModalBtn" aria-label="Close"><i data-lucide="x" style="width:18px;height:18px;"></i></button></div>'
    + '<div class="modal-body">'
...
window.Ledger.openPersonModal = function(existing){
  ...
  var html = ''
    + '<div class="modal-head"><h3>' + (isEdit?'Edit person':'Add person') + '</h3><button class="icon-btn" id="closeModalBtn" aria-label="Close"><i data-lucide="x" style="width:18px;height:18px;"></i></button></div>'
    + '<div class="modal-body">'
...
window.Ledger.openCategorySplitModal = function(totalAmount, existingSplits, onDone){
  ...
  function render(){
    ...
    var html = ''
      + '<div class="modal-head"><h3>Split across categories</h3><button class="icon-btn" id="closeSubBtn" aria-label="Close"><i data-lucide="x" style="width:18px;height:18px;"></i></button></div>'
      + '<div class="modal-body">'
...
window.Ledger.openFriendSplitModal = function(totalAmount, existing, onDone){
  ...
  function render(){
    ...
    var html = ''
      + '<div class="modal-head"><h3>Split with friends</h3><button class="icon-btn" id="closeSubBtn" aria-label="Close"><i data-lucide="x" style="width:18px;height:18px;"></i></button></div>'
      + '<div class="modal-body">'
