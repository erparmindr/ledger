...
window.Ledger.openTextPromptModal = function (title, placeholder, initial, onSave) {
  var html = ''
    + '<div class="modal-head"><h3>' + window.Ledger.escapeHtml(title) + '</h3><button class="icon-btn" id="closeModalBtn" aria-label="Close"><i data-lucide="x" style="width:18px;height:18px;"></i></button></div>'
...
window.Ledger.openMarkPaidModal = function (debtItem) {
  ...
  var html = ''
    + '<div class="modal-head"><h3>Mark as paid</h3><button class="icon-btn" id="closeModalBtn" aria-label="Close"><i data-lucide="x" style="width:18px;height:18px;"></i></button></div>'
